(function() {
  ...
  this["Color"]["initialize"] = dtlbind(this, function(arg1, arg2, arg3) {
    ...
    dtlbind(this, function() {
      var self = this;
      var 自分 = self;
      return arg1["toString"]()["match"](
        root["window"]["RegExp"]("^#[0-9A-F]{6}$")
      );
    })
      ["then"]()
      ["else"](
  ...
  this["Color"]["setCMYK"] = dtlbind(this, function() {
    ...
    this["magenta"] =
      (1 - this["g"] / 255 - this["black"]) / (1 - this["black"]);
    this["yellow"] =
      (1 - this["b"] / 255 - this["black"]) / (1 - this["black"]);
    return this;
  });
  this["Color"]["fromCMYK"] = dtlbind(this, function(
    cyan,
    magenta,
    yellow,
    black
    ...
    return this["Color"]["create"](
      ...
      (1 - this["window"]["Math"]["min"](1, magenta * (1 - black) + black)) *
        255,
