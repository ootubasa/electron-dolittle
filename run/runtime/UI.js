(function() {
    ...
    dtlbind(this, function() {
      ...
      ["execute"](
        dtlbind(this, function() {
          ...
          var _rest = Array.prototype.slice.call(arguments, 0);
          return (v =
            this["window"]["Math"]["round"](v * this["num2strDigits"]) /
            this["num2strDigits"]);
        })
      );
    return v + "";
        ...
        dtlbind(this, function() {
          ...
          return root["window"]["$"](
            dtlbind(this, function() {
              ...
              var 自分 = self;
              var _rest = Array.prototype.slice.call(arguments, 0);
              return root["window"]["document"]["addEventListener"](
                "keydown",
  ...
  return (this["SelectMenu"]["add"] = dtlbind(this, function() {
    ...
    var _rest = Array.prototype.slice.call(arguments, 0);
    var opt;
    this["args"] = root["window"]["Array"]["prototype"]["slice"]["call"](
      arguments
    );
    this["args"]["each"](
      dtlbind(this, function(e) {
