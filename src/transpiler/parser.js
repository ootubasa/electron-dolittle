Parser = (function() {
  ...
  Parser.create = function(parseFunc) {
    // (State->State)->Parser
  ...
  extend(Parser.prototype, {
    ...
    and: function(next) {
      // Parser.and:: (Function|Parser)  -> Parser
    ...
    unifyFirst: function(other) {
      ...
      if ($.options.verboseFirst)
        console.log(
          "Created unify name=" + res.name + " tbl=" + $.dispTbl(tbl)
        );
      return res;
    },
    or: function(other) {
    ...
    tap: function(msg) {
      ...
      var res = Parser.create(function(s) {
        console.log(
          "tap:" + msg + " name:" + t.name + "  pos=" + (s ? s.pos : "?")
        );
        var r = t.parse(s);
        var img =
          r.src.str.substring(r.pos - 3, r.pos) +
          "^" +
          r.src.str.substring(r.pos, r.pos + 3);
        console.log(
          "/tap:" +
            msg +
            " name:" +
