...
function ExpressionParser() {
  ...
  function opType(type, prio) {
    var $ = {};
    $.eq = function(o) {
      return type == o.type() && prio == o.prio();
    };
    $.type = function(t) {
      if (!t) return type;
      else return t == type;
  ...
  function typeComposite() {
    ...
    $.reg = function(type, prio, a) {
      ...
      built.add(
        Parser.Parser.create(function(st) {
  ...
  var prefixOrElement = typeComposite(),
    postfixOrInfix = typeComposite();
