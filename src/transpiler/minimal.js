MinimalParser = (function() {
  ...
  var expr,
    ...
    program,
    statement_list;
  var infix_expr_lazy = Parser.lazy(function() {
    return infix_expr;
  });
  var expr_lazy = Parser.lazy(function() {
    return expr;
  });
  var term_lazy = Parser.lazy(function() {
    return term;
  });
  var variable_lazy = Parser.lazy(function() {
    return variable;
  });
  var block_lazy = Parser.lazy(function() {
    return block;
  });
  var meth_call_lazy = Parser.lazy(function() {
    return meth_call_lazy;
  });
  var paren_lazy = Parser.lazy(function() {
    return paren_expr;
  });
  var program_lazy = Parser.lazy(function() {
    return program;
  });
  var statement_list_lazy = Parser.lazy(function() {
    return statement_list;
  });
  //--------字句要素
  //名前
  var str_name =
    "[a-zａ-ｚA-ZＡ-Ｚ_＿\\$＄\\?？ーぁ-んァ-ヶ々〇〻\u3400-\u9FFF\uF900-\uFAFF\uD840-\uD87F\uDC00-\uDFFF][a-zａ-ｚA-ZＡ-Ｚ_＿\\$＄\\?？0-9０-９ーぁ-んァ-ヶ々〇〻\u3400-\u9FFF\uF900-\uFAFF\uD840-\uD87F\uDC00-\uDFFF]*";
  ...
  var colon = token(/^[:：]/).ret(function() {
    return ":";
  });
  var lsb = token(/^[\[「]/).ret(function() {
    return "[";
  });
  var rsb = token(/^[\]」]/).ret(function() {
    return "]";
  });
  var stick = token(/^[|｜]/).ret(function() {
    return "|";
  });
  var period = token(/^[.。．]/).ret(function() {
    return ".";
  });
  var lp = token(/^[(（]/).ret(function() {
    return "(";
  });
  var rp = token(/^[)）]/).ret(function() {
    return ")";
  });
  var excr = token(/^[!！]/).ret(function() {
    return "!";
  });
  var semicolon = token(/^[;；]/).ret(function() {
    return ";";
  });
  var eq = token(/^[=＝]/)
    .noFollow(token(/^[=＝]/))
  ...
  var deq = token(/^[=＝][=＝]/).ret(function() {
    return "===";
  });
  var add = token(/^[+＋]/).ret(function() {
    return "+";
  });
  var sub = token(/^[-−–－]/).ret(function() {
    return "-";
  });
  var mul = token(/^[*×＊∗]/).ret(function() {
    return "*";
  });
  var div = token(/^[/÷／]/).ret(function() {
    return "/";
  });
  var gt = token(/^[>＞]/).ret(function() {
    return ">";
  });
  var ge = token(/^(?:[>＞][=＝])|≧/).ret(function() {
    return ">=";
  });
  var lt = token(/^[<＜]/).ret(function() {
    return "<";
  });
  var le = token(/^(?:[<＜][=＝])|≦/).ret(function() {
    return "<=";
  });
  var neg = token(/^(?:[!！][=＝])|≠/).ret(function() {
    return "!==";
  });
  var mod = token(/^[%％]/).ret(function() {
    return "%";
  });
  ...
  //単純式
  var simple = block_lazy
    .or(tok_str)
    .or(paren_expr)
    .or(tok_num)
    .or(unary_term);
  // sin(x) なども送信の一種...にしないほうがいい
  var func_exe = token_name.and(paren_expr).ret(function(_name, _paren) {
    return extend([_paren, ".", _name, "()"], {
      type: "func_exec",
      subnodes: arguments
    });
  });
  ...
  //送信
  var meth_call = term_lazy
    .opt()
    .and(excr)
    .and(elec)
    .ret(function(obj, _, elec) {
      return extend([obj || "this", elec], {
        type: "meth_call",
        subnodes: arguments
      });
    }); //.or(func_exe);
  ...
  function mk(left, op, right) {
    return extend(["(", left, op, right, ")"], {
      type: "infix",
      subnodes: arguments
    });
  }
  function mkpre(op, right) {
    return extend([op, right], { type: "prefix", subnodes: arguments });
  }
  function mkpost(left, op) {
    return extend([left, op], { type: "postfix", subnodes: arguments });
  }
  infix_expr = expbuild.build();
  //ブロック := [  [ | 引数リスト  |  文 . *  ]
  var block_param = stick
    .and(token_name.rep0())
    .and(semicolon.opt())
    .and(token_name.rep0())
    .and(stick)
  ...
  varbuild.element(
    simple
      ...
      .or(
        colon.and(token_name).ret(function(_, n) {
  ...
  varbuild.postfix(
    1,
    colon.and(token_name).ret(function(_, name) {
  ...
  statement_list = statement
    ...
    .ret(function(_stmts) {
      ...
      var last = stmts.pop();
      return extend([stmts, "return ", last], {
        type: "statement_list",
        subnodes: arguments
      });
    });
