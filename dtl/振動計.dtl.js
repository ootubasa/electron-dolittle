(function() {
  ...
  this["メモリ"]
    ["作る"]()
    ["塗る"](this["色"]["作る"](255, 255, 255))
    ["位置"](250, -250);
  this["メモリ"]
    ["作る"]()
    ["塗る"](this["色"]["作る"](255, 240, 240))
    ["位置"](250, -188);
  this["メモリ"]
    ["作る"]()
    ["塗る"](this["色"]["作る"](255, 224, 224))
    ["位置"](250, -125);
  this["メモリ"]
    ["作る"]()
    ["塗る"](this["色"]["作る"](255, 208, 208))
    ["位置"](250, -63);
  this["メモリ"]
    ["作る"]()
  ...
  this["メモリ"]
    ["作る"]()
    ["塗る"](this["色"]["作る"](255, 176, 176))
    ["位置"](250, 63);
  this["メモリ"]
    ["作る"]()
    ["塗る"](this["色"]["作る"](255, 160, 160))
    ["位置"](250, 125);
  this["メモリ"]
    ["作る"]()
    ["塗る"](this["色"]["作る"](255, 144, 144))
    ["位置"](250, 188);
  this["かめた"]
    ["ペンなし"]()
    ["位置"](250, -250)
  ...
  this["タイマー"]
    ...
    ["実行"](
      dtlbind(this, function() {
        ...
        this["線"]["位置"](250, (this["振動0"] * 500) / 4 - 250);
        this["線max"]["位置"](250, (this["振動Max"] * 500) / 4 - 250);
        this["動いているとき"]["実行"]();
